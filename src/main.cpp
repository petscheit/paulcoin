...
uint256 hashGenesisBlock("0x76576cebcdb90e032202e49f270adecf0cd34b6b650b4266f43a04f2aee56759");
...
const string strMessageMagic = "paulcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // paulcoin: 1 days
static const int64 nTargetSpacing = 120; // paulcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal paulcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "paulcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4b2af5fb1ab95a27d139cdbb83ad708216d64db28757c7f9c7f86cc10dbcd481");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Chille gerad in Nizza, fett am pool, probier diese zu funktionieren";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1502654976; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 502805;

        if (fTestNet)
        {
            block.nTime    = 1502635577;
            block.nNonce   = 464417;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x856adc0d0e79880c5b4047ad916fe7e0e8f9cd38a8d4ab314c0e14e36754682b"));
